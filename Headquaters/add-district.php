                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if(!empty($district) && !empty($region)){
                                $sqlInsert = "INSERT INTO districts (district, regionname) VALUES('$district','$region')";
                      ...
                      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1054">
                        <form action="" method="POST" class="row g-3">
                          <div class="col-md-3">
                            ...
                            <input name="district" class="form-control"  aria-disabled="true"  id="validationServer01" type="text" required="">
                          </div>
